...
const PrintDocument: React.FC<{ result: AnalysisResult; dealTitle?: string; deal?: DealOpportunity; showReferences?: boolean }> = ({ result, dealTitle, deal, showReferences }) => {
  return (
    <div className="bg-white text-slate-900 font-sans p-10 max-w-[210mm] mx-auto">
       ...
       <div className="flex justify-between items-start border-b-2 border-cyan-500 pb-6 mb-8 gap-8">
        ...
        <div className="mt-20 border-t border-slate-200 pt-8 flex justify-between items-center text-[10px] text-slate-400 uppercase tracking-widest">
            ...
            <span>Powered by DealScout AI & C4 Infinity Framework</span>
        </div>
    </div>
  );
};
             ...
             <div className="flex items-start space-x-4">
                 <div>
                     ...
                     <p className="text-slate-400 text-xs uppercase tracking-widest mt-1">
                       Generated by DealScout AI • {new Date().toLocaleDateString()}
                     </p>
                 </div>
             </div>
